...
It's written completely in Java, and it's open sourced. It's currently being maintained and developed by [Konloch](https://github.com/Konloch).
...
#### Contribution Guide Lines/Coding Conventions ####
 ...
 - All packages must start with `the.bytecode.club.bytecodeviewer`
 - You must catch exceptions using `new the.bytecode.club.bytecodeviewer.ExceptionUI(exception, "authors@email.com")`
