...
public class MainViewerGUI extends JFrame
{
    ...
    public final JMenuItem classParser = new TranslatedJMenuItem("Class parser", TranslatedComponents.CLASS_PARSER);
    ...
    public void buildPluginMenu()
    {
        ...
        pluginsMainMenu.add(classParser);
        ...
        classParser.addActionListener(arg0 -> PluginManager.runPlugin(new ClassParser()));
    }
