                        ...
                        if (returnVal == JFileChooser.APPROVE_OPTION) {
                            ...
                            if (result == 0) {
                                Thread t = new Thread() {
                                    ...
                                    public void run() {
                                        try {
                                            Decompiler.procyon.decompileToZip(tempZip.getAbsolutePath(),
                            MiscUtils.append(javaSucks, "-proycon.zip"));
                                ...
                                Thread t2 = new Thread() {
                                    ...
                                    public void run() {
                                        try {
                                            BytecodeViewer.viewer.setIcon(true);
                                            Decompiler.cfr.decompileToZip(tempZip.getAbsolutePath(),
 MiscUtils.append(javaSucks, "-CFR.zip"));
                                ...
                                Thread t3 = new Thread() {
                                    ...
                                    public void run() {
                                        try {
                                            BytecodeViewer.viewer.setIcon(true);
                                            Decompiler.fernflower.decompileToZip(tempZip.getAbsolutePath(),
                                ...
                                Thread t4 = new Thread() {
                                    ...
                                    public void run() {
                                        try {
                                            BytecodeViewer.viewer.setIcon(true);
                                            Decompiler.krakatau.decompileToZip(tempZip.getAbsolutePath(),
                            ...
                            if (result == 0) {
                                Thread t = new Thread() {
                                    ...
                                    public void run() {
                                        ...
                                        Decompiler.procyon.decompileClassNode(cn, cw.toByteArray()), false);
                                            } catch (Exception e) {
                                                e.printStackTrace();
                                            }
                                            ...
                                            try {
                                                ...
                                                Decompiler.cfr.decompileClassNode(cn, cw.toByteArray()), false);
                                            } catch (Exception e) {
                                                e.printStackTrace();
                                            }
                                            ...
                                            try {
                                                ...
                                                Decompiler.fernflower.decompileClassNode(cn, cw.toByteArray()), false);
                                            } catch (Exception e) {
                                                e.printStackTrace();
                                            }
                                            ...
                                            Decompiler.krakatau.decompileClassNode(cn, cw.toByteArray()), false);
                                            } catch (Exception e) {
                                                e.printStackTrace();
                                            }
                                ...
                                Thread t = new Thread() {
                                    ...
                                    public void run() {
                                        try {
                                            ...
                                            String contents = Decompiler.procyon.decompileClassNode(cn,
                                    cw.toByteArray());
                                ...
                                Thread t = new Thread() {
                                    ...
                                    public void run() {
                                        try {
                                            ...
                                            String contents = Decompiler.fernflower.decompileClassNode(cn,
 cw.toByteArray());
                                            DiskWriter.replaceFile(path, contents, false);
                                            BytecodeViewer.viewer.setIcon(false);
                                        } catch (Exception e) {
                                ...
                                Thread t = new Thread() {
                                    ...
                                    public void run() {
                                        try {
                                            ...
                                            String contents = Decompiler.krakatau.decompileClassNode(cn,
                                            cw.toByteArray());
                                            DiskWriter.replaceFile(path, contents, false);
                                            BytecodeViewer.viewer.setIcon(false);
                                        } catch (Exception e) {
