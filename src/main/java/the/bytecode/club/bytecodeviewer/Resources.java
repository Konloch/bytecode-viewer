...
public class Resources {
	...
	static {
		...
		busyIcon = new ImageIcon(Resources.class.getClass().getResource("/1.gif"));
		...
		batIcon = new ImageIcon(Resources.class.getClass().getResource("/bat.png"));
		shIcon = new ImageIcon(Resources.class.getClass().getResource("/sh.png"));
		csharpIcon = new ImageIcon(Resources.class.getClass().getResource("/c#.png"));
		cplusplusIcon = new ImageIcon(Resources.class.getClass().getResource("/c++.png"));
		configIcon = new ImageIcon(Resources.class.getClass().getResource("/config.png"));
		jarIcon = new ImageIcon(Resources.class.getClass().getResource("/jar.png"));
		zipIcon= new ImageIcon(Resources.class.getClass().getResource("/zip.png"));
		packagesIcon = new ImageIcon(Resources.class.getClass().getResource("/package.png"));
		folderIcon = new ImageIcon(Resources.class.getClass().getResource("/folder.png"));
		androidIcon = new ImageIcon(Resources.class.getClass().getResource("/android.png"));
		fileIcon = new ImageIcon(Resources.class.getClass().getResource("/file.png"));
		textIcon = new ImageIcon(Resources.class.getClass().getResource("/text.png"));
		classIcon = new ImageIcon(Resources.class.getClass().getResource("/class.png"));
		imageIcon = new ImageIcon(Resources.class.getClass().getResource("/image.png"));
